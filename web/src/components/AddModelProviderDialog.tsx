  ...
  return (
    ...
    >
      <section
        ...
        className="max-h-[88dvh] w-full max-w-xl overflow-y-auto rounded-2xl border border-border bg-card shadow-2xl shadow-background/60"
      >
        <header className="sticky top-0 z-10 flex items-center justify-between border-b border-border bg-card/95 px-5 py-4 backdrop-blur">
          <div>
            <h3 id="add-provider-title" className="text-lg font-semibold text-foreground">添加模型供应商</h3>
          </div>
          <button
            type="button"
            onClick={onClose}
            ...
            <>
              <label className="block text-sm text-foreground">
                ...
                <select
                  ...
                  className="mt-1 min-h-11 w-full appearance-none rounded-lg border border-border bg-secondary px-3 text-sm text-foreground outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
                >
              ...
              <label className="block text-sm text-foreground">
                ...
                <input
                  ...
                  className="mt-1 min-h-11 w-full rounded-lg border border-border bg-secondary px-3 font-mono text-sm text-foreground outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
                />
                {providerIdExists && (
                  <span id="provider-id-error" className="mt-1 block text-xs text-warning">
                    该 ID 已存在
                  </span>
                )}
              </label>
                ...
                {apiExpanded && (
                  <div className="border-t border-border p-3">
                    <input
                      ...
                      aria-label="API 地址"
                      className="min-h-11 w-full rounded-lg border border-border bg-secondary px-3 font-mono text-sm text-foreground outline-none focus:border-primary"
                    />
        ...
        <footer className="sticky bottom-0 flex justify-end gap-3 border-t border-border bg-card/95 px-5 py-4 backdrop-blur">
          <button type="button" onClick={onClose} className="min-h-11 rounded-lg border border-border px-4 text-sm text-foreground hover:bg-secondary">取消</button>
          <button
            type="button"
            ...
            className="flex min-h-11 items-center gap-2 rounded-lg bg-primary px-4 text-sm font-medium text-white hover:bg-primary disabled:cursor-not-allowed disabled:opacity-40"
          >
