  ...
  return (
    <div className="flex items-center gap-2 my-4" role="separator" aria-label="压缩分隔线">
      ...
      <div className="flex-shrink-0 max-w-[85%]">
        <div className="bg-secondary/80 border border-border/50 rounded-lg px-4 py-2">
          <div className="flex items-center gap-2">
            {(() => {
              const IconComponent = ICONS[compressionType] || Pin;
              return <IconComponent size={16} className="text-muted-foreground" aria-hidden="true" />;
            })()}
            ...
            {hasSummary && (
              <button
                ...
                className="ml-1 flex items-center gap-1 text-xs text-primary hover:text-primary transition-colors cursor-pointer min-h-[44px]"
